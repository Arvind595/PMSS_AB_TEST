...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC_CONSTANT 16_26-08-2026/DAC_CONSTANT 16/DAC_CONSTANT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_test_16ch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_test_16ch.tcl
