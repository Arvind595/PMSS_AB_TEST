...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/pmss_ab_test/pmss_ab_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ab_check.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ab_check.tcl
