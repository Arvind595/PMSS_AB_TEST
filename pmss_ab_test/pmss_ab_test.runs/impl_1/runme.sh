...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/pmss_ab_test/pmss_ab_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ab_check.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ab_check.tcl -notrace
