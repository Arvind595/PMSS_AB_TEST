...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC RESET/DAC RESET.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_RESET_ALL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_RESET_ALL.tcl
