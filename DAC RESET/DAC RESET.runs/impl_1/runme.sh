...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC RESET/DAC RESET.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_RESET_ALL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAC_RESET_ALL.tcl -notrace
