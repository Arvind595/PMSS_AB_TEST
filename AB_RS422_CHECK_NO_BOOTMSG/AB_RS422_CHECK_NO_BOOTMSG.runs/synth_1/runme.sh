...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/AB_RS422_CHECK_NO_BOOTMSG/AB_RS422_CHECK_NO_BOOTMSG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs422_docklight_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs422_docklight_test.tcl
