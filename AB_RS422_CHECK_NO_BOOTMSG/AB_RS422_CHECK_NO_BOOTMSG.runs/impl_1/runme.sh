...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/AB_RS422_CHECK_NO_BOOTMSG/AB_RS422_CHECK_NO_BOOTMSG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rs422_docklight_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rs422_docklight_test.tcl -notrace
