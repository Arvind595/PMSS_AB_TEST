...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/dac_spi_single_test/dac_spi_single_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad3551r_dc_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad3551r_dc_test_top.tcl
