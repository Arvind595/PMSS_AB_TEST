...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC16_RS422_SPI/DAC16_RS422_SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac16_uart_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac16_uart_controller.tcl -notrace
