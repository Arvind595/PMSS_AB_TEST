...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC16_RS422_SPI/DAC16_RS422_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac16_uart_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac16_uart_controller.tcl
