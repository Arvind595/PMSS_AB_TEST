...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC_CONSTANT/DAC_CONSTANT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac_test.tcl -notrace
