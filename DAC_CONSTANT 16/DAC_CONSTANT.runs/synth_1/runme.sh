...
HD_PWD='C:/Arvind/Projects/PMSS/VHDL/AB/13-08-2026/PMSS_AB_TEST/DAC_CONSTANT/DAC_CONSTANT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac_test.tcl
